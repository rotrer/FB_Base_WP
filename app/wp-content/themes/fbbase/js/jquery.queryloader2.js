            ...
            if (qLoptions.completeAnimation == "grow") {
                ...
                $(qLbar).stop().animate(
                    ...
                    },
                    {
                        ...
                        fail : function(){
                            //console.log("fallo! primer!");
                        },
                        progress : function(){
                            //console.log("on progress primer!");
                        },
                        complete : function(){
                            $(this).animate(
                                {
                                ...
                                },
                                {
                                    duration : 500,
                                    fail : function(){
                                        //console.log("fallo! segundo!");
                                    },
                                    progress : function(){
                                        //console.log("on progress segundo!");
                                    },
                                    complete : function(){
                                        //console.log("ON animate complete");
                                        $('#'+qLoptions.overlayId).fadeOut(500, function () {
                                            //console.log("ON fade");
                                            $(this).remove();
                                            qLoptions.onComplete();
    ...
    var completeImageLoading = function () {
        ...
        $(qLbar).stop().animate(
            ...
            },
            {
                duration : 200,
                fail : function(){
                    //console.log("fallo! completeImageLoading");
                },
                progress : function(){
                    //console.log("on progress completeImageLoading");
                },
                complete : function(){
                    //console.log("COMPLETE COMPLETE COMPLETE  completeImageLoading");
                    var animationTime = 500;
                    var currentTime = new Date();
                    if ((currentTime.getTime() - qLstart) < qLoptions.minimumTime) {
                        animationTime = (qLoptions.minimumTime - (currentTime.getTime() - qLstart));
